...
export async function POST(req: NextRequest) {
  ...
  await query(
    `INSERT INTO staff (first_name,last_name,email,phone,role,department,password_hash,created_by,approved_by,approved_at)
     VALUES ($1,$2,$3,$4,$5,$6,$7,$8,$8,NOW())`,
    [first_name, last_name, email.toLowerCase(), phone||null, staffRole, department||null, password_hash, createdBy]
  );
